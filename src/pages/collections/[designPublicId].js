          ...
          return (
            <div key={id} className='flex items-center justify-center'>
              <div className='max-w-sm'>
                <a href={url} target='_blank' className='flex flex-col h-fit md:h-72 relative items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700' rel='noreferrer'>
