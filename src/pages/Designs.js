  ...
  return (
    <>
      ...
      <div className='w-full py-5 flex flex-wrap justify-evenly mt-8 gap-5'>
        {designs.map(({ name, publicId, date }) => {
          ...
          return (
            <div key={publicId} className='w-full relative max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-[460px]'>
              ...
              <div className='px-5 pb-5'>
                ...
                <div className='flex flex-1 items-center justify-end'>
                  <a href={`/ShowResults/${publicId}`} className='text-green-500 border-2 border-green-500 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:hover:bg-green-700 dark:focus:ring-green-800'>Go to Merch</a>
                </div>
              </div>
            </div>
          )
